...
public class MainController {
	...
	@PostMapping("/quiz")
	public String quiz(@RequestParam String username,@RequestParam int numberOfQ,@RequestParam String technology, Model m, RedirectAttributes ra) {
		if(username.isEmpty()) {
		...
		QuestionForm qForm = qService.getQuestions(numberOfQ,technology);
